...
|**url** | **URI** | Absolute URL of the request, without a \\#fragment suffix. Only HTTP and HTTPS schemes are supported. |  |
|**ipv4Address** | **String** | Client IPv4 address observed by your server. |  [optional] |
|**ipv6Address** | **String** | Client IPv6 address observed by your server. |  [optional] |
