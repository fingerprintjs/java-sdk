...
public class SealedTest {
    ...
    public void unsealEventResponseWithInvalidJsonSealedResultTest() throws Exception {
        ...
        assertThrows(JsonEOFException.class, () -> Sealed.unsealEventResponse(
                sealedResult,
                new Sealed.DecryptionKey[]{
                        new Sealed.DecryptionKey(
                                //Invalid key
