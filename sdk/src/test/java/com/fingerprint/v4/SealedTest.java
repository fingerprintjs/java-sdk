...
import com.fingerprint.v4.Sealed.InvalidSealedDataException;
...
public class SealedTest {
    ...
    Event eventResponse =
        Sealed.unsealEventResponse(
            ...
            new Sealed.DecryptionKey[] {
              ...
              new Sealed.DecryptionKey(key, Sealed.DecryptionAlgorithm.AES_256_GCM)
            });
  ...
  public void unsealEventResponseWithInvalidSealedResultTest() throws Exception {
    ...
    byte[] sealedResult =
        Base64.getDecoder()
            .decode("noXc7VOpBstjjcavDKSKr4HTavt4mdq8h6NC32T0hUtw9S0jXT8lPjZiWL8SyHxmrF3uTGqO+g==");
    byte[] key = Base64.getDecoder().decode("p2PA7MGy5tx56cnyJaFZMr96BCFwZeHjZV2EqMvTq53=");

    assertThrows(
        Sealed.InvalidSealedDataException.class,
        () ->
            Sealed.unsealEventResponse(
                sealedResult,
                new Sealed.DecryptionKey[] {
  ...
  public void unsealEventResponseWithNotCompressedSealedResultTest() throws Exception {
    ...
    Sealed.UnsealAggregateException exception =
        assertThrows(
            Sealed.UnsealAggregateException.class,
            () ->
                Sealed.unsealEventResponse(
                    sealedResult,
                    new Sealed.DecryptionKey[] {
                      new Sealed.DecryptionKey(
                          // Invalid key
                          Base64.getDecoder()
                              .decode("p2PA7MGy5tx56cnyJaFZMr96BCFwZeHjZV2EqMvTq54="),
                          Sealed.DecryptionAlgorithm.AES_256_GCM),
                      new Sealed.DecryptionKey(
                          // Invalid key
                          Base64.getDecoder().decode("aW52YWxpZA=="),
  ...
  public void unsealEventResponseWithInvalidHeaderTest() throws Exception {
    ...
    assertThrows(
        Sealed.InvalidSealedDataHeaderException.class,
        () ->
            Sealed.unsealEventResponse(
                sealedResult,
                new Sealed.DecryptionKey[] {
  ...
  @Test
  public void unsealEventResponseWithEmptyDataTest() throws Exception {
    byte[] sealedResult = new byte[0];
    byte[] key = Base64.getDecoder().decode("p2PA7MGy5tx56cnyJaFZMr96BCFwZeHjZV2EqMvTq53=");
  ...
  public void unsealEventResponseWithEmptyEventTest() throws Exception {
    byte[] sealedResult =
        Base64.getDecoder().decode("noXc7enbFVmf0ITsHkrqGgSDC0UNR/MIVD3hvIBk8qL1Y2/SHzr5S2E=");
    byte[] key = Base64.getDecoder().decode("p2PA7MGy5tx56cnyJaFZMr96BCFwZeHjZV2EqMvTq53=");

    InvalidSealedDataException ex =
        assertThrows(
            Sealed.InvalidSealedDataException.class,
            () ->
                Sealed.unsealEventResponse(
  ...
  public void unsealEventResponseWithInvalidNonceTest() throws Exception {
    byte[] sealedResult =
        new byte[] {
          (byte) 0x9E, (byte) 0x85, (byte) 0xDC, (byte) 0xED, (byte) 0xAA, (byte) 0xBB, (byte) 0xCC
        };
    byte[] key = Base64.getDecoder().decode("p2PA7MGy5tx56cnyJaFZMr96BCFwZeHjZV2EqMvTq53=");
