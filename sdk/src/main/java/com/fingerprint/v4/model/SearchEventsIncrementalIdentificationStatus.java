...
public enum SearchEventsIncrementalIdentificationStatus {
  ...
  SearchEventsIncrementalIdentificationStatus(String value) {
    this.value = value;
  }
  ...
  @JsonCreator
  public static SearchEventsIncrementalIdentificationStatus fromValue(String value) {
    for (SearchEventsIncrementalIdentificationStatus b :
        SearchEventsIncrementalIdentificationStatus.values()) {
